...
class Settings(BaseSettings):
    ...
    git_commit_sha: Optional[str] = Field(
        default=None, description="Git commit SHA from deployment"
    )
    build_timestamp: Optional[str] = Field(
        default=None, description="Build timestamp from deployment"
    )
    ...
    smtp_from_email: str = Field(
        default="hr@baynunah.ae", description="From email address"
    )
